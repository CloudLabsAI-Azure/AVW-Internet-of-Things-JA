...
## ソリューション アーキテクチャ
  ...
  ![Lab 04 アーキテクチャ](media/lab4_architecture.png)
...
1. **[詳細設定を表示]** をクリックして、次の詳細を入力します。
   ...
   * ファイル共有: **[新規作成]** を選択し、**blob** と入力します
   ...
   ![ストレージ アカウントを作成するための選択パスを表示している Azure ポータルのスクリーンショット。](media/storageaccount01.png)
...
1. パスワードの入力を求められたら、**Password.1!!** と入力し、**Enter** キーを押します。
   ...
   ![linuxagent 仮想マシンへ接続中。](media/vmlogin.png)
